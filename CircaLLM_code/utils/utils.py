...
class NamespaceWithDefaults(Namespace):#相当于增强了Namespace的功能
    @classmethod
    def from_namespace(cls, namespace):
        new_instance = cls()
        for attr in dir(namespace):#dir用于查看对象的属性和方法
            if not attr.startswith("__"):
                setattr(new_instance, attr, getattr(namespace, attr))#setattr(object, name, value)
        return new_instance
